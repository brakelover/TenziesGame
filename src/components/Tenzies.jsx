...
export default function Tenzies({ mess, setMess }) {
            ...
            {tenzies
                ...
                <>
                    ...
                    <div style={{ display: 'flex' }}>
                        <button style={{ marginRight: '20px', backgroundColor: 'gray' }} className='roll-btn' onClick={goBack}>Back</button>
                        <button className="roll-btn" onClick={resetGame}>New Game</button>
                    </div>
                </>
                :
